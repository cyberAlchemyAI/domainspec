...
| UPS-CON-011   | FR-016..FR-018, FR-021 | Genetic population, fitness, and lineage family contract              | [SPEC.md](SPEC.md#functional-requirements-mvp), [workflows.md](workflows.md#godeldarwinevolutionworkflow)                  |
| UPS-CON-012   | FR-019, FR-020         | Godel proof gate and MVP self-improvement deferral                    | [SPEC.md](SPEC.md#functional-requirements-mvp), [operations.md](operations.md#evaluateproofgate)                           |
| UPS-CON-013   | AC-001..AC-016         | Acceptance criteria completeness and traceability                     | [SPEC.md](SPEC.md#acceptance-criteria-mvp), [SPEC.md](SPEC.md#traceability-matrix-stories---fr---ac---aspect-evidence)     |
...
| UPS-ST-010 | [EvolutionCycleState](states.md#evolutioncyclestate) preserves population -> fitness -> lineage -> proof ordering.             | Transition         | [states.md](states.md#evolutioncyclestate) |
...
| UPS-OP-014 | [SelectOrCommitBaseline](operations.md#selectorcommitbaseline) creates a [BaselineGenealogyFamily](domain.md#baselinegenealogyfamily) with population and survivor provenance. | Side effect     | [operations.md](operations.md#selectorcommitbaseline)  |
...
| UPS-OP-012 | [EvaluateProofGate](operations.md#evaluateproofgate) blocks when evidence is missing or any obligation is `block`.                                                             | Rule validation | [operations.md](operations.md#evaluateproofgate)       |
...
| State machine obligations  | 12               |
| Operation rule obligations | 14               |
| Interface obligations      | 11               |
| UI obligations             | 8                |
| Total                      | 58               |
