...
| ------------------------ | -------------------------------------------------------------------------------------------------------- |
| Canonical scenario       | One selected-stage scenario (`selectionPolicy=stage-subset`, ordered `selectedStages`)                   |
...
- Lock one canonical selected-stage scenario for Capability 2 gate evidence (`selectionPolicy=stage-subset`, ordered `selectedStages`).
