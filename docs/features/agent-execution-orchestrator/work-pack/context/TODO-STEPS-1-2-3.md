...
- [x] Step 2 - WP-01 inventory baseline
  - Evidence: [TASK-AEO-WP-01.md](../tasks/TASK-AEO-WP-01.md), [command-agent-inventory.md](command-agent-inventory.md)
  - Note: already completed before this request; confirmed and reused.
- [x] Step 3 - prompt-ready route artifact
  - Evidence: [route-artifact-prompt-pack.md](route-artifact-prompt-pack.md), [TASK-AEO-WP-02.md](../tasks/TASK-AEO-WP-02.md)
