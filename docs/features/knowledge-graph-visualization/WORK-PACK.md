...
| KG-IMP-10 | UI-SPEC.md, TEST-SPEC.md, IMPLEMENTATION-PLAN.md | KG-UI-NAV-002, KG-UI-JRN-003, KG-UI-STATE-003, KG-UI-STATE-004                                               | ../../UI-ARCHITECTURE.md, ../../../ARCHITECTURE.md#ui-concepts                                 | Enforce browser history restore semantics for `aspect -> feature -> concept` navigation, align concept detail relation field mapping, and eliminate duplicate React key warnings | web check + targeted KG E2E + live smoke |
...
- work-pack/tasks/TASK-KG-IMP-10.md
...
| ui-pipeline           | yes      | W2           | in-progress | web check + test:e2e pass                     | frontend regression follow-up tracked in KG-IMP-10 |
