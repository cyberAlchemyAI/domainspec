...
| activePlanRef     | docs/features/knowledge-graph-visualization/work-pack/waves/W1.md | Active implementation planning wave                    |
| lastPlannedAt     | 2026-05-03T19:20:00Z                                              | ISO timestamp                                          |
...
| --------- | -------------------------------------------------------------------------- | ---------- | -------------- | ---------------- | ----------- |
| KG-IMP-01 | Implement docs-to-projection parser and canonical edge validation          | high       | W1, W2         | ready            | not-started |
| KG-IMP-02 | Implement read/interaction API contracts for cards, graph, and definitions | high       | W1, W2         | ready            | not-started |
| KG-IMP-03 | Implement UI mirror cards + graph + detail interactions                    | high       | W1, W2         | ready            | not-started |
| KG-IMP-04 | Implement deterministic tests from TEST-SPEC and reach pilot readiness     | medium     | W2, W3         | ready-after-impl | not-started |
...
| W1   | Backend projection and API contracts               | W0 complete                              | Parser/API contracts implemented and checked | not-started | work-pack/waves/W1.md |
| W2   | UI interactions and full contract tests            | W1 complete                              | UI + tests pass for required obligations     | not-started | work-pack/waves/W2.md |
...
| tests                 | yes      | W2           | not-started | TEST-SPEC.md            | pending implementation |
| backend-implement     | yes      | W1, W2       | not-started | pending                 | pending                |
| ui-pipeline           | yes      | W2           | not-started | UI-SPEC.md              | pending implementation |
