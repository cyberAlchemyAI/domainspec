...
- Name: knowledge-graph-visualization/knowledge-graph-visualization.responsive.spec.ts >> Knowledge Graph Visualization - Responsive >> renders primary regions on desktop
