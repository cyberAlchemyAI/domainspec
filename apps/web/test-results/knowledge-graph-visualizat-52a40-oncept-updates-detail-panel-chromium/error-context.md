...
- Name: knowledge-graph-visualization/knowledge-graph-visualization.journey.spec.ts >> Knowledge Graph Visualization - Journeys >> US-4 selecting concept updates detail panel
- Location: e2e/knowledge-graph-visualization/knowledge-graph-visualization.journey.spec.ts:19:3
...
Call log:
  - waiting for getByRole('button', { name: /Focus concept/i }).first()
