...
- Name: knowledge-graph-visualization/knowledge-graph-visualization.accessibility.spec.ts >> Knowledge Graph Visualization - Accessibility >> required ARIA semantics are present for graph and live-updating detail regions
- Location: e2e/knowledge-graph-visualization/knowledge-graph-visualization.accessibility.spec.ts:36:3
...
Locator: getByRole('img', { name: 'Concept relationship graph' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('img', { name: 'Concept relationship graph' })
