...
- Name: knowledge-graph-visualization/knowledge-graph-visualization.forms.spec.ts >> Knowledge Graph Visualization - Form and Interaction >> open definition requires selected concept
- Location: e2e/knowledge-graph-visualization/knowledge-graph-visualization.forms.spec.ts:8:3
...
Call log:
  - waiting for getByRole('button', { name: 'Open definition' })
