...
- Name: knowledge-graph-visualization/knowledge-graph-visualization.states.spec.ts >> Knowledge Graph Visualization - State Reflection >> shows projection-ready state after initial load
- Location: e2e/knowledge-graph-visualization/knowledge-graph-visualization.states.spec.ts:8:3
...
Locator: getByText('Projection Ready')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Projection Ready')
