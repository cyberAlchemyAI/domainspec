...
This project is indexed by GitNexus as **domainspec** (3563 symbols, 6071 relationships, 186 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
