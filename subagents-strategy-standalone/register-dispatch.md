...
3. Run the appender (prefer the Bash tool). The appender ships alongside this doc in the
   standalone package — adjust the package path if you relocated it:
   ```sh
   node "$CLAUDE_PROJECT_DIR/packages/subagents-strategy-standalone/append-dispatch.cjs" \
