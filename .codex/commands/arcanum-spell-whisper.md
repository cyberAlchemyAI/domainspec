...
<!-- arcanum:command arcanum-spell-whisper -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-spell-whisper-<UTC timestamp>`.
