...
<!-- arcanum:command arcanum-sigil-structured-interview-kits -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-structured-interview-kits-<UTC timestamp>`.
