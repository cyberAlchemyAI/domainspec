...
<!-- arcanum:command structured-interview-kits -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-structured-interview-kits-<UTC timestamp>`.
