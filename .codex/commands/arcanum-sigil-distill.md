...
<!-- arcanum:command arcanum-sigil-distill -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-distill-<UTC timestamp>`.
