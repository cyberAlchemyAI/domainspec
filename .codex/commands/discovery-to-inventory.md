...
<!-- arcanum:command discovery-to-inventory -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-discovery-to-inventory-<UTC timestamp>`.
