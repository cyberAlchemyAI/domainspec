...
<!-- arcanum:command arcanum-sigil-definitions-governance -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-definitions-governance-<UTC timestamp>`.
