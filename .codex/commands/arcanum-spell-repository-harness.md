...
<!-- arcanum:command arcanum-spell-repository-harness -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-spell-repository-harness-<UTC timestamp>`.
