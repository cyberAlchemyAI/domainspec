...
<!-- arcanum:command implementation-readiness -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-implementation-readiness-<UTC timestamp>`.
