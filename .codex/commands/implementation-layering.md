...
<!-- arcanum:command implementation-layering -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-implementation-layering-<UTC timestamp>`.
