...
<!-- arcanum:command arcanum-sigil-inventory -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-inventory-<UTC timestamp>`.
