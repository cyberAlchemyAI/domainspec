...
<!-- arcanum:command arcanum-ontology-harness -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-ontology-harness-<UTC timestamp>`.
