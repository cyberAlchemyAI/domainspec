...
<!-- arcanum:command arcanum-sigil-invoke-example-runner -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-invoke-example-runner-<UTC timestamp>`.
