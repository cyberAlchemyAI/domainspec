...
<!-- arcanum:command sigil-maintenance-loop -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-sigil-maintenance-loop-<UTC timestamp>`.
