...
<!-- arcanum:command arcanum-sigil-residuality-spec -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-residuality-spec-<UTC timestamp>`.
