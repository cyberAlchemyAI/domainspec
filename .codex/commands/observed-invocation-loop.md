...
<!-- arcanum:command observed-invocation-loop -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-observed-invocation-loop-<UTC timestamp>`.
