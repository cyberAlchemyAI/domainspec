...
<!-- arcanum:command arcanum-sigil-decision-gate -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-decision-gate-<UTC timestamp>`.
