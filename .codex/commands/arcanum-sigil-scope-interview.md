...
<!-- arcanum:command arcanum-sigil-scope-interview -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-scope-interview-<UTC timestamp>`.
