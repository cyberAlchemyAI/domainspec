...
<!-- arcanum:command arcanum-sigil-spellcraft -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-spellcraft-<UTC timestamp>`.
