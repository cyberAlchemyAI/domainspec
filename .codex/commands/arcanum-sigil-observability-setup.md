...
<!-- arcanum:command arcanum-sigil-observability-setup -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-observability-setup-<UTC timestamp>`.
