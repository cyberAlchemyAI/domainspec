...
<!-- arcanum:command architecture-pattern-inventory -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-architecture-pattern-inventory-<UTC timestamp>`.
