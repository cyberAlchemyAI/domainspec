...
<!-- arcanum:command arcanum-sigil-sigil-runtime-installer -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-sigil-runtime-installer-<UTC timestamp>`.
