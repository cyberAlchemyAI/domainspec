...
<!-- arcanum:command arcanum-sigil-sigil-development -->
...
- `run_id`: use an existing hook-provided run id when present; otherwise use `arcanum-arcanum-sigil-sigil-development-<UTC timestamp>`.
