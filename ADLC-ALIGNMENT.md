...
| **L1 — Understanding (Ontology)**  | TAXONOMY.md (25 types) + RELATIONSHIPS.md (29 edges) + domain.md templates | ✅ Richer than Meta-Track (13 types, 12 edges) | No runtime `@biz`/`@sys` code-to-doc binding → concepts live in docs but code can drift silently                  |
