...
| G7  | **Economy of Action metrics**      | Principle 10 — Minimize computational and cognitive load      | PIPELINE-REPORT.md template + pipeline Step 10 capture counters (v1.8)        | Track and report: tokens consumed, agent calls made, human questions asked, time-to-verdict per feature                                                   |
| G8  | **Reflection and auto-tuning**     | Principle 12 — System reflects and tunes at every interaction | `domainspec-reflect` skill + pipeline Step 10 produce structured retrospective (v1.8) | After each pipeline run, agent analyzes what worked/failed, proposes prompt/skill improvements, and logs them for review                                  |
