...
- Codex CLI for automated reflection and tuning proposals
...
Enable when: project has `docs/signals/pipeline-signals.jsonl` and `domainspec/Codex/skills/domainspec-reflect/SKILL.md`.
