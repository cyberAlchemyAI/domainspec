...
- **New concepts**: the domain dictionary is not yet implemented — check canonical vocabulary in `docs/registry.md`, `docs/glossary.md`, and `docs/features/*/SPEC.md` — do not invent a term that already exists
