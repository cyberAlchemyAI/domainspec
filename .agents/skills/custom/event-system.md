...
4. Record the event concept in canonical vocabulary — the events dictionary is not yet implemented; use `docs/registry.md`, `docs/glossary.md`, and `docs/features/*/SPEC.md`
