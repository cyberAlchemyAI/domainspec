...
- `false` — everything else, including docs produced _by_ a session.
...
The _shape_ of the text if printed. A reading instruction for agents. Multi-value allowed.
