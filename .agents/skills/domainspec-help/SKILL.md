...
<context>
Read command definitions under domainspec/Codex/skills/, package docs under domainspec/Codex/, and framework updates in domainspec/CHANGELOG.md.
</context>
...
4. Recommend next command based on detected docs and feature readiness.
	...
	- If the request asks to create or evolve a feature glossary, recommend `domainspec-feature-glossary <feature>`.
	- If the request asks to create or evolve implementation layering docs (POC-first rollout), recommend `domainspec-implementation-layering <feature>`.
