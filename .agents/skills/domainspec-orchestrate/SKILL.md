...
<context>
Read command definitions under `.Codex/skills/domainspec-*/SKILL.md`, package docs under `domainspec/copilot/`, and framework updates in `domainspec/CHANGELOG.md`.
</context>
