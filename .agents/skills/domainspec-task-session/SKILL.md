...
6. Ask the user to choose each decision:
   - Preferred: AskUserQuestion with objective option labels and concise consequences.
   - If `--auto`, choose the recommended option and record that it was auto-selected.
   - If AskUserQuestion is unavailable, use plain numbered choices in chat and require explicit selection.
