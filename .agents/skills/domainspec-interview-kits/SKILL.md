...
- `.Codex/skills/domainspec-interview-kits/MODE-REGISTRY.md`
- `.Codex/skills/domainspec-interview-kits/MODES/*.md`
- `.Codex/skills/domainspec-interview-kits/TEMPLATES/question-card.md`
...
1. Add one mode file under `.Codex/skills/domainspec-interview-kits/MODES/`.
2. Add one row in `.Codex/skills/domainspec-interview-kits/MODE-REGISTRY.md`.
3. Define:
