...
<flags>
- `--live`: Enable live metric verification through MCP Prometheus connection. Requires `.mcp.json` with prometheus server configured and a running OTel Collector.
