...
- If you need to understand *why* a rule exists (e.g., "why can't presenters fetch?") → read the Rationale under the relevant rule in `vault/constitution/frontend-constitution.md`
