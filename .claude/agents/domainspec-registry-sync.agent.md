...
6. **Emit signals** — follow `.claude/skills/domainspec-emit-signals/SKILL.md` to append any spec gaps or patterns discovered during registry sync to `docs/signals/pipeline-signals.jsonl`.
</execution>
