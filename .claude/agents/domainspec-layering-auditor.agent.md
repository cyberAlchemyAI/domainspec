...
7. **Emit signals** — follow `.claude/skills/domainspec-emit-signals/SKILL.md` to append any alignment gaps, governance gaps, or patterns discovered during the layering audit to `docs/signals/pipeline-signals.jsonl`.
</execution>
