...
10. **Emit signals** — follow `.claude/skills/domainspec-emit-signals/SKILL.md` to append any alignment gaps, spec gaps, rework, decisions, or patterns discovered during implementation to `docs/signals/pipeline-signals.jsonl`.
</execution>
