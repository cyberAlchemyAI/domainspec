...
- Keep this file stable and evolve intentionally.
- Add domain-specific governance blueprints in docs/shared/ when needed.
- Do not bypass this baseline for money, permission, or lifecycle behavior.
