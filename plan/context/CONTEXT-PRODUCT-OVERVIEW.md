...
- Stakeholders cannot explain why one task outranks another.
- Execution evidence is fragmented and hard to audit.

## Core Product Capabilities

### 1) Objective-Based Prioritization Engine (CTX-01)

- Defines objective schema, scoring dimensions, and blocker overrides.
- Converts strategy into operational task ranking.
- Makes prioritization explainable and auditable.

### 2) Knowledge Mapping Tutorial (CTX-02)

- Teaches how concepts, relationships, transformations, and governance connect.
- Reduces onboarding friction and mapping inconsistencies.
- Creates repeatable domain understanding across roles.

### 3) Initiative and Vision Tracker (CTX-03)

- Tracks initiatives, owners, status, and evidence.
...
- Top-priority order is explainable in one sentence per task.
