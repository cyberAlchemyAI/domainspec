...
| [discovery/domainspec-subagents-strategy-definitions/domainspec-subagents-strategy.md](../discovery/domainspec-subagents-strategy-definitions/domainspec-subagents-strategy.md) | `derives` | The domainspec-subagents-strategy discovery cites P-SYS-3 (docs as source of truth) and P-SYS-7 (revisability) as the ground for its briefing-contract (P-SS-6) and grading (P-SS-10) premises. |
