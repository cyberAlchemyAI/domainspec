...
| `vault/discovery/certification-on-the-wrong-object/discovery.md` | `derives` | Downstream diagnosis: supplies the prevention-vs-measurement gap that this node's residue-counter telemetry plan (D-6) presupposes. |
