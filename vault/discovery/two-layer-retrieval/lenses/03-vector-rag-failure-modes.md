---
lens: vector-rag-failure-modes
date: 2026-05-16
dispatched_by: subagent (general-purpose, Sonnet) — 21 tool calls, web-fetched
addresses: Empirically catalog documented failures of vector RAG in graph-structured corpora; map to the four schema-layer concerns (type erasure, edge erasure, stage collapse, identity violation)
sources:
  - https://arxiv.org/abs/2404.16130 (Microsoft GraphRAG)
  - https://arxiv.org/html/2502.14802v1 (HippoRAG 2)
  - https://arxiv.org/html/2506.05690v3 (When to Use Graphs in RAG, 2025 survey)
  - https://arxiv.org/html/2407.12216v2 (Mindful-RAG)
  - https://ar5iv.labs.arxiv.org/html/2401.05856 (Seven Failure Points)
  - https://www.anthropic.com/news/contextual-retrieval
  - https://arxiv.org/abs/2307.03172 (Lost in the Middle)
  - https://arxiv.org/html/2503.04800v1 (HoH temporal benchmark)
  - https://arxiv.org/html/2408.10343v1 (LegalBench-RAG)
verification: [web-fetched]
---

# Vector-RAG Failure Mode Catalog
