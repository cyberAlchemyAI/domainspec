...
| `vault/discovery/agent-context-boundary-rule/discovery.md` | `cited-by` | The agent-context boundary rule operationalizes AX-ONT-1/3/4/6/7 against the CLAUDE.md + MEMORY.md boundary object. |
