...
description: 'Interview a greenfield or brownfield project to discover domain scope, inspect what is already implemented, and produce DomainSpec-ready project overview, definitions, hypotheses, and experiment candidates.'
