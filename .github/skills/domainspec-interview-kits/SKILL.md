---
name: domainspec-interview-kits
description: "Run structured one-question-at-a-time interviews using pluggable interview modes (grill, readiness, audit-gap, Robot-Talks synthesis) and patch docs/specs as decisions are made."
argument-hint: "<target-scope> [--mode <mode-id>|auto] [--robot-talks off|on]"
...
- `.github/skills/domainspec-interview-kits/MODE-REGISTRY.md`
- `.github/skills/domainspec-interview-kits/MODES/*.md`
- `.github/skills/domainspec-interview-kits/TEMPLATES/question-card.md`
...
1. Add one mode file under `.github/skills/domainspec-interview-kits/MODES/`.
2. Add one row in `.github/skills/domainspec-interview-kits/MODE-REGISTRY.md`.
3. Define:
   ...
   - patch targets,
   - exit criteria.
4. Do not change this orchestrator skill unless the mode system contract changes.
</mode-extension-contract>
...
<examples>
- `/domainspec-interview-kits docs/features/agent-execution-orchestrator --mode grill-with-docs --robot-talks on`
- `/domainspec-interview-kits docs/features/payment-recovery --mode audit-gap`
- `/domainspec-interview-kits docs/features/player-settlement --mode auto`
</examples>
